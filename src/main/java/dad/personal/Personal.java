...
public class Personal {
	...
	public Personal(String identificador, String nombre, String apellidos,
			LocalDate fechaNacimiento, String direccion, String codigoPostal,
			String localidad, String pais, ListProperty<Nacionalidad> nacionalidades) {
		super();
